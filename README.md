<h1 align="center">Ignite - React - Desafio 01 - Conceitos do React</h1>
...
```bash
$ git clone https://github.com/Jonathan-Rios/ignite-react-challenge-1.git

$ cd ignite-react-challenge-1
```
